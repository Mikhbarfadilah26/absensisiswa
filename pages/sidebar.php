      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Data Kelas<i class="fas fa-angle-left right"></i></p>
          </a>
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Data siswa<i class="fas fa-angle-left right"></i></p>
          </a>
          <ul class="nav nav-treeview">
            <li class="nav-item">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="index.php?halaman=absen" class="nav-link"><i class="far fa-circle nav-icon"></i>
                <p>Absen</p>
              </a></li>
        ...
        <li class="nav-item has-treeview">
          <a href="#" class="nav-link">
            ...
            <p>Data Sesi Kehadiran<i class="fas fa-angle-left right"></i></p>
          </a>
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="index.php?halaman=kehadiran" class="nav-link"><i class="far fa-circle nav-icon"></i>
                <p>Sesi Kehadiran</p>
              </a></li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item"><a href="index.php?halaman=detilkehadiran" class="nav-link"><i class="far fa-circle nav-icon"></i>
                <p>Detil Kehadiran</p>
              </a></li>
